...
## Features 🔥
- Fully generated C# SDK based on the [official Exa Public API v2 OpenAPI specification](https://exa.ai/docs/exa-spec.yaml) using [AutoSDK](https://github.com/HavenDV/AutoSDK)
