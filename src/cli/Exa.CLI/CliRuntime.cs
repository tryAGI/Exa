...
{
    private const string UserSecretsId = "Exa.CLI";
    private const string UserSecretApiKeyName = "EXA_API_KEY";
    private static readonly string[] ApiKeyEnvironmentVariables = [@"EXA_API_KEY"];
    private const string CredentialFileDirectoryName = ".exa";

    public static async global::System.Threading.Tasks.Task<global::Exa.ExaClient> CreateClientAsync(ParseResult parseResult, CancellationToken cancellationToken = default)
    {
        ...
        var authorizations = string.IsNullOrWhiteSpace(apiKey)
            ? new global::System.Collections.Generic.List<global::Exa.EndPointAuthorization>()
            : new global::System.Collections.Generic.List<global::Exa.EndPointAuthorization>
            {
        CreateAuthorization(
            type: "Http",
        ...
        return new global::Exa.ExaClient(
            httpClient: null,
            baseUri: baseUri,
    ...
    private static global::Exa.EndPointAuthorization CreateAuthorization(
        string type,
        string schemeId,
        string location,
        string name,
        string value)
    {
        var authorization = new global::Exa.EndPointAuthorization
        {
            Type = type,
            Location = location,
            Name = name,
        ...
        var schemeIdProperty = typeof(global::Exa.EndPointAuthorization).GetProperty("SchemeId");
    ...
    public static async global::System.Threading.Tasks.Task<int> RunAsync(Func<global::System.Threading.Tasks.Task> action, CancellationToken cancellationToken = default)
    {
        ...
        catch (global::Exa.ApiException exception)
        {
    ...
    private static Uri? ResolveBaseUri(ParseResult parseResult)
    {
        ...
        {
            baseUrl = Environment.GetEnvironmentVariable("EXA_BASE_URL");
        }
    ...
    private static async global::System.Threading.Tasks.Task WriteApiExceptionAsync(global::Exa.ApiException exception)
    {
        var builder = new StringBuilder();
