...
internal static class CliRuntime
{
    ...
    public static async Task<global::Exa.ExaClient> CreateClientAsync(ParseResult parseResult, CancellationToken cancellationToken = default)
    {
    ...
    private static async Task WriteApiExceptionAsync(global::Exa.ApiException exception)
    {
        var builder = new StringBuilder();
