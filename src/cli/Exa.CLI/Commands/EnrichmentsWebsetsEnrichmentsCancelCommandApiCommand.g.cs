...
internal static partial class EnrichmentsWebsetsEnrichmentsCancelCommandApiCommand
{
    ...
    {
        var command = new Command(@"websets-enrichments-cancel", @"Cancel a running Enrichment
        ...
        command.SetAction(async (ParseResult parseResult, CancellationToken cancellationToken) =>
            await CliRuntime.RunAsync(async () =>
            {
                ...
                using var client = await CliRuntime.CreateClientAsync(parseResult, cancellationToken).ConfigureAwait(false);
                                ...
                                var response = await client.Enrichments.WebsetsEnrichmentsCancelAsync(
                                    webset: webset,
                                    id: id,
