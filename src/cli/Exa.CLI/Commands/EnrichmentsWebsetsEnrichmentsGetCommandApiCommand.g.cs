...
internal static partial class EnrichmentsWebsetsEnrichmentsGetCommandApiCommand
{
    ...
    {
        var command = new Command(@"websets-enrichments-get", @"Get an Enrichment");
        ...
        command.SetAction(async (ParseResult parseResult, CancellationToken cancellationToken) =>
            await CliRuntime.RunAsync(async () =>
            {
                ...
                using var client = await CliRuntime.CreateClientAsync(parseResult, cancellationToken).ConfigureAwait(false);
                                ...
                                var response = await client.Enrichments.WebsetsEnrichmentsGetAsync(
                                    webset: webset,
                                    id: id,
