...
internal static partial class GetContentsCommandApiCommand
{
    ...
    {
        var command = new Command(@"get-contents", @"Get Contents");
        ...
        command.SetAction(async (ParseResult parseResult, CancellationToken cancellationToken) =>
            await CliRuntime.RunAsync(async () =>
            {
                        ...
                        var request = await CliRuntime.ReadRequestAsync<global::Exa.AllOf<global::Exa.GetContentsRequest2, global::Exa.ContentsRequest>>(
                            parseResult,
                            Input,
                            RequestJson,
                            RequestFile,
