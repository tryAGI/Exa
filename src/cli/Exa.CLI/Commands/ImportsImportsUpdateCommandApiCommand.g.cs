...
internal static partial class ImportsImportsUpdateCommandApiCommand
{
        ...
        name: @"--title")
    {
      ...
      private static Option<string?> RequestFile { get; } = new(@"--request-file")
      {
          ...
          Hidden = true,
                    ...
                    private static string FormatResponse(ParseResult parseResult, global::Exa.Import value, global::System.Text.Json.Serialization.JsonSerializerContext context, bool truncateLongStrings)
                    {
                        string? text = null;
                    ...
                    static partial void CustomizeResponseText(ParseResult parseResult, global::Exa.Import value, ref string? text);
                    static partial void CustomizeResponseFormatHints(Dictionary<string, CliFormatHint> hints);


    public static Command Create()
    {
        var command = new Command(@"update", @"Update Import
Updates a import configuration.");
        ...
        command.SetAction(async (ParseResult parseResult, CancellationToken cancellationToken) =>
            ...
            {
                        var __requestBase = await CliRuntime.ReadRequestOrDefaultAsync<global::Exa.UpdateImport>(
                            parseResult,
                            Input,
                            RequestJson,
                            RequestFile,
                ...
                using var client = await CliRuntime.CreateClientAsync(parseResult, cancellationToken).ConfigureAwait(false);
                                ...
                                var response = await client.Imports.ImportsUpdateAsync(
                                    id: id,
                                    metadata: metadata,
                                    title: title,
