...
internal static partial class SearchesWebsetsSearchesCancelCommandApiCommand
{
    ...
    {
        var command = new Command(@"websets-searches-cancel", @"Cancel a running Search
        ...
        command.SetAction(async (ParseResult parseResult, CancellationToken cancellationToken) =>
            await CliRuntime.RunAsync(async () =>
            {
                ...
                using var client = await CliRuntime.CreateClientAsync(parseResult, cancellationToken).ConfigureAwait(false);
                                ...
                                var response = await client.Searches.WebsetsSearchesCancelAsync(
                                    webset: webset,
                                    id: id,
