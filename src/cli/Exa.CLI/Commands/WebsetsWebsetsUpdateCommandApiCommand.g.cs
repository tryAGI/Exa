...
internal static partial class WebsetsWebsetsUpdateCommandApiCommand
{
    ...
    {
        var command = new Command(@"update", @"Update a Webset");
        ...
        command.SetAction(async (ParseResult parseResult, CancellationToken cancellationToken) =>
            ...
            {
                        var __requestBase = await CliRuntime.ReadRequestOrDefaultAsync<global::Exa.UpdateWebsetRequest>(
                            parseResult,
                            Input,
                            RequestJson,
                            RequestFile,
                ...
                using var client = await CliRuntime.CreateClientAsync(parseResult, cancellationToken).ConfigureAwait(false);
                                ...
                                var response = await client.Websets.WebsetsUpdateAsync(
                                    id: id,
                                    metadata: metadata,
                                    title: title,
