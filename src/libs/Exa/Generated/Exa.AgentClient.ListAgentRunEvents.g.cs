...
namespace Exa
{
    public partial class AgentClient
    {
        ...
        private static readonly global::Exa.EndPointSecurityRequirement s_ListAgentRunEventsSecurityRequirement0 =
        ...
        private static readonly global::Exa.EndPointSecurityRequirement[] s_ListAgentRunEventsSecurityRequirements =
            new global::Exa.EndPointSecurityRequirement[]
            {                s_ListAgentRunEventsSecurityRequirement0,
            };
        partial void PrepareListAgentRunEventsArguments(
        ...
        partial void PrepareListAgentRunEventsRequest(
            global::System.Net.Http.HttpClient httpClient,
            ...
            string? lastEventId);
        partial void ProcessListAgentRunEventsResponse(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage);

        partial void ProcessListAgentRunEventsResponseContent(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage,
            ref string content);
        ...
        /// print(events)
        /// </remarks>
        public async global::System.Threading.Tasks.Task<global::Exa.AgentRunEventList> ListAgentRunEventsAsync(
            string id,
            int? limit = default,
        ...
        {
            var __response = await ListAgentRunEventsAsResponseAsync(
                id: id,
                limit: limit,
                cursor: cursor,
                accept: accept,
        ...
        /// print(events)
        /// </remarks>
        public async global::System.Threading.Tasks.Task<global::Exa.AutoSDKHttpResponse<global::Exa.AgentRunEventList>> ListAgentRunEventsAsResponseAsync(
            string id,
            int? limit = default,
            string? cursor = default,
            global::Exa.ListAgentRunEventsAccept? accept = default,
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            PrepareArguments(
                client: HttpClient);
            PrepareListAgentRunEventsArguments(
            ...
            var __authorizations = global::Exa.EndPointSecurityResolver.ResolveAuthorizations(
                ...
                securityRequirements: s_ListAgentRunEventsSecurityRequirements,
                operationName: "ListAgentRunEventsAsync");
            ...
            if (lastEventId != default)
            {
                ...
                PrepareRequest(
                    client: HttpClient,
                    request: __httpRequest);
                PrepareListAgentRunEventsRequest(
                    httpClient: HttpClient,
            ...
            try
            {
                for (var __attempt = 1; __attempt <= __maxAttempts; __attempt++)
                {
                    ...
                    await global::Exa.AutoSDKRequestOptionsSupport.OnBeforeRequestAsync(
                            ...
                            context: global::Exa.AutoSDKRequestOptionsSupport.CreateHookContext(
                                ...
                                methodName: "ListAgentRunEventsAsync",
                ...
                ProcessResponse(
                    client: HttpClient,
                    response: __response);
                ProcessListAgentRunEventsResponse(
                    httpClient: HttpClient,
                ...
                else
                {
                    await global::Exa.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            if ((int)__response.StatusCode == 404)
                            {
                                ...
                                global::Exa.AgentErrorResponse? __value_404 = null;
                                try
                                {
                                    if (__effectiveReadResponseAsString)
                                    {
                                        __content_404 = await __response.Content.ReadAsStringAsync(__effectiveCancellationToken).ConfigureAwait(false);
                                        __value_404 = global::Exa.AgentErrorResponse.FromJson(__content_404, JsonSerializerContext);
                                    }
                                    else
                                    {
                                        __content_404 = await __response.Content.ReadAsStringAsync(__effectiveCancellationToken).ConfigureAwait(false);
                            ...
                            if (__effectiveReadResponseAsString)
                            {
                                ...
                                ProcessListAgentRunEventsResponseContent(
                                    httpClient: HttpClient,
                                    httpResponseMessage: __response,
                                    content: ref __content);
                                ...
                                try
                                {
                                    ...
                                    var __value = global::Exa.AgentRunEventList.FromJson(__content, JsonSerializerContext) ??
                                        throw new global::System.InvalidOperationException($"Response deserialization failed for \"{__content}\" ");
                                    return new global::Exa.AutoSDKHttpResponse<global::Exa.AgentRunEventList>(
                                        statusCode: __response.StatusCode,
                            ...
                            else
                            {
                                try
                                {
                                    ...
                                    var __value = await global::Exa.AgentRunEventList.FromJsonStreamAsync(__content, JsonSerializerContext).ConfigureAwait(false) ??
