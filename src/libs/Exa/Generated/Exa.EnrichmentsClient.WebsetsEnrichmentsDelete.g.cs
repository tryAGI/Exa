...
namespace Exa
{
    public partial class EnrichmentsClient
    {
        ...
        private static readonly global::Exa.AutoSDKServer[] s_WebsetsEnrichmentsDeleteServers = new global::Exa.AutoSDKServer[]
        ...
        private static readonly global::Exa.EndPointSecurityRequirement s_WebsetsEnrichmentsDeleteSecurityRequirement0 =
        ...
        private static readonly global::Exa.EndPointSecurityRequirement[] s_WebsetsEnrichmentsDeleteSecurityRequirements =
            new global::Exa.EndPointSecurityRequirement[]
            {                s_WebsetsEnrichmentsDeleteSecurityRequirement0,
            };
        partial void PrepareWebsetsEnrichmentsDeleteArguments(
            global::System.Net.Http.HttpClient httpClient,
            ref string webset,
            ref string id);
        partial void PrepareWebsetsEnrichmentsDeleteRequest(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpRequestMessage httpRequestMessage,
            string webset,
            string id);
        partial void ProcessWebsetsEnrichmentsDeleteResponse(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage);

        partial void ProcessWebsetsEnrichmentsDeleteResponseContent(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage,
            ref string content);
        ...
        /// </remarks>
        public async global::System.Threading.Tasks.Task<global::Exa.WebsetEnrichment> WebsetsEnrichmentsDeleteAsync(
            string webset,
            string id,
            global::Exa.AutoSDKRequestOptions? requestOptions = default,
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            var __response = await WebsetsEnrichmentsDeleteAsResponseAsync(
                webset: webset,
                id: id,
        ...
        /// console.log("Enrichment deleted successfully");
        /// </remarks>
        public async global::System.Threading.Tasks.Task<global::Exa.AutoSDKHttpResponse<global::Exa.WebsetEnrichment>> WebsetsEnrichmentsDeleteAsResponseAsync(
            string webset,
            string id,
            global::Exa.AutoSDKRequestOptions? requestOptions = default,
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            PrepareArguments(
                client: HttpClient);
            PrepareWebsetsEnrichmentsDeleteArguments(
            ...
            var __authorizations = global::Exa.EndPointSecurityResolver.ResolveAuthorizations(
                ...
                securityRequirements: s_WebsetsEnrichmentsDeleteSecurityRequirements,
                operationName: "WebsetsEnrichmentsDeleteAsync");
            ...
            global::System.Net.Http.HttpRequestMessage __CreateHttpRequest()
            {
                            ...
                            var __pathBuilder = new global::Exa.PathBuilder(
                                ...
                                servers: s_WebsetsEnrichmentsDeleteServers,
            ...
            foreach (var __authorization in __authorizations)
            {
                ...
                PrepareRequest(
                    client: HttpClient,
                    request: __httpRequest);
                PrepareWebsetsEnrichmentsDeleteRequest(
                    httpClient: HttpClient,
            ...
            try
            {
                for (var __attempt = 1; __attempt <= __maxAttempts; __attempt++)
                {
                    ...
                    await global::Exa.AutoSDKRequestOptionsSupport.OnBeforeRequestAsync(
                            ...
                            context: global::Exa.AutoSDKRequestOptionsSupport.CreateHookContext(
                                operationId: "WebsetsEnrichmentsDelete",
                                methodName: "WebsetsEnrichmentsDeleteAsync",
                ...
                ProcessResponse(
                    client: HttpClient,
                    response: __response);
                ProcessWebsetsEnrichmentsDeleteResponse(
                    httpClient: HttpClient,
                ...
                else
                {
                    await global::Exa.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            if (__effectiveReadResponseAsString)
                            {
                                ...
                                ProcessWebsetsEnrichmentsDeleteResponseContent(
                                    httpClient: HttpClient,
                                    httpResponseMessage: __response,
                                    content: ref __content);
