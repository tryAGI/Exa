...
namespace Exa
{
    public partial class EnrichmentsClient
    {
        ...
        private static readonly global::Exa.AutoSDKServer[] s_WebsetsEnrichmentsGetServers = new global::Exa.AutoSDKServer[]
        ...
        private static readonly global::Exa.EndPointSecurityRequirement s_WebsetsEnrichmentsGetSecurityRequirement0 =
        ...
        private static readonly global::Exa.EndPointSecurityRequirement[] s_WebsetsEnrichmentsGetSecurityRequirements =
            new global::Exa.EndPointSecurityRequirement[]
            {                s_WebsetsEnrichmentsGetSecurityRequirement0,
            };
        partial void PrepareWebsetsEnrichmentsGetArguments(
            global::System.Net.Http.HttpClient httpClient,
            ref string webset,
            ref string id);
        partial void PrepareWebsetsEnrichmentsGetRequest(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpRequestMessage httpRequestMessage,
            string webset,
            string id);
        partial void ProcessWebsetsEnrichmentsGetResponse(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage);

        partial void ProcessWebsetsEnrichmentsGetResponseContent(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage,
            ref string content);
        ...
        /// </remarks>
        public async global::System.Threading.Tasks.Task<global::Exa.WebsetEnrichment> WebsetsEnrichmentsGetAsync(
            string webset,
            string id,
            global::Exa.AutoSDKRequestOptions? requestOptions = default,
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            var __response = await WebsetsEnrichmentsGetAsResponseAsync(
                webset: webset,
                id: id,
        ...
        /// console.log(`Enrichment: ${enrichment.id} - ${enrichment.status}`);
        /// </remarks>
        public async global::System.Threading.Tasks.Task<global::Exa.AutoSDKHttpResponse<global::Exa.WebsetEnrichment>> WebsetsEnrichmentsGetAsResponseAsync(
            string webset,
            string id,
            global::Exa.AutoSDKRequestOptions? requestOptions = default,
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            PrepareArguments(
                client: HttpClient);
            PrepareWebsetsEnrichmentsGetArguments(
            ...
            var __authorizations = global::Exa.EndPointSecurityResolver.ResolveAuthorizations(
                ...
                securityRequirements: s_WebsetsEnrichmentsGetSecurityRequirements,
                operationName: "WebsetsEnrichmentsGetAsync");
            ...
            global::System.Net.Http.HttpRequestMessage __CreateHttpRequest()
            {
                            ...
                            var __pathBuilder = new global::Exa.PathBuilder(
                                ...
                                servers: s_WebsetsEnrichmentsGetServers,
            ...
            foreach (var __authorization in __authorizations)
            {
                ...
                PrepareRequest(
                    client: HttpClient,
                    request: __httpRequest);
                PrepareWebsetsEnrichmentsGetRequest(
                    httpClient: HttpClient,
            ...
            try
            {
                for (var __attempt = 1; __attempt <= __maxAttempts; __attempt++)
                {
                    ...
                    await global::Exa.AutoSDKRequestOptionsSupport.OnBeforeRequestAsync(
                            ...
                            context: global::Exa.AutoSDKRequestOptionsSupport.CreateHookContext(
                                operationId: "WebsetsEnrichmentsGet",
                                methodName: "WebsetsEnrichmentsGetAsync",
                ...
                ProcessResponse(
                    client: HttpClient,
                    response: __response);
                ProcessWebsetsEnrichmentsGetResponse(
                    httpClient: HttpClient,
                ...
                else
                {
                    await global::Exa.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            if (__effectiveReadResponseAsString)
                            {
                                ...
                                ProcessWebsetsEnrichmentsGetResponseContent(
                                    httpClient: HttpClient,
                                    httpResponseMessage: __response,
                                    content: ref __content);
