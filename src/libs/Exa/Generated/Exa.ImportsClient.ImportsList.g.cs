...
namespace Exa
{
    public partial class ImportsClient
    {
        ...
        private static readonly global::Exa.EndPointSecurityRequirement[] s_ImportsListSecurityRequirements =
            new global::Exa.EndPointSecurityRequirement[]
            {                s_ImportsListSecurityRequirement0,
            };
        ...
        partial void ProcessImportsListResponseContent(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage,
            ref string content);
        ...
        {
            var __response = await ImportsListAsResponseAsync(
                cursor: cursor,
                limit: limit,
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            ...
            var __authorizations = global::Exa.EndPointSecurityResolver.ResolveAuthorizations(
                ...
                securityRequirements: s_ImportsListSecurityRequirements,
                operationName: "ImportsListAsync");
                ...
                else
                {
                    await global::Exa.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            if (__effectiveReadResponseAsString)
                            {
                                ...
                                ProcessImportsListResponseContent(
                                    httpClient: HttpClient,
                                    httpResponseMessage: __response,
                                    content: ref __content);
                                ...
                                try
                                {
                                    ...
                                    var __value = global::Exa.ListImportsResponse.FromJson(__content, JsonSerializerContext) ??
                                        throw new global::System.InvalidOperationException($"Response deserialization failed for \"{__content}\" ");
                                    return new global::Exa.AutoSDKHttpResponse<global::Exa.ListImportsResponse>(
                            ...
                            else
                            {
                                try
                                {
                                    ...
                                    var __value = await global::Exa.ListImportsResponse.FromJsonStreamAsync(__content, JsonSerializerContext).ConfigureAwait(false) ??
