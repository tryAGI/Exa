...
namespace Exa
{
    public partial class ImportsClient
    {
        ...
        private static readonly global::Exa.AutoSDKServer[] s_ImportsUpdateServers = new global::Exa.AutoSDKServer[]
        ...
        private static readonly global::Exa.EndPointSecurityRequirement s_ImportsUpdateSecurityRequirement0 =
        ...
        private static readonly global::Exa.EndPointSecurityRequirement[] s_ImportsUpdateSecurityRequirements =
            new global::Exa.EndPointSecurityRequirement[]
            {                s_ImportsUpdateSecurityRequirement0,
            };
        partial void PrepareImportsUpdateArguments(
            global::System.Net.Http.HttpClient httpClient,
            ref string id,
            global::Exa.UpdateImport request);
        partial void PrepareImportsUpdateRequest(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpRequestMessage httpRequestMessage,
            string id,
            global::Exa.UpdateImport request);
        partial void ProcessImportsUpdateResponse(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage);

        partial void ProcessImportsUpdateResponseContent(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage,
            ref string content);
        ...
        /// </remarks>
        public async global::System.Threading.Tasks.Task<global::Exa.Import> ImportsUpdateAsync(
            string id,
        ...
        {
            var __response = await ImportsUpdateAsResponseAsync(
                id: id,
        ...
        /// console.log(`Updated import: ${importJob.id}`);
        /// </remarks>
        public async global::System.Threading.Tasks.Task<global::Exa.AutoSDKHttpResponse<global::Exa.Import>> ImportsUpdateAsResponseAsync(
            string id,
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            ...
            var __authorizations = global::Exa.EndPointSecurityResolver.ResolveAuthorizations(
                ...
                securityRequirements: s_ImportsUpdateSecurityRequirements,
                operationName: "ImportsUpdateAsync");
            ...
            global::System.Net.Http.HttpRequestMessage __CreateHttpRequest()
            {
                            ...
                            var __pathBuilder = new global::Exa.PathBuilder(
                                ...
                                servers: s_ImportsUpdateServers,
                ...
                for (var __attempt = 1; __attempt <= __maxAttempts; __attempt++)
                {
                    ...
                    await global::Exa.AutoSDKRequestOptionsSupport.OnBeforeRequestAsync(
                            ...
                            context: global::Exa.AutoSDKRequestOptionsSupport.CreateHookContext(
                                ...
                                methodName: "ImportsUpdateAsync",
                                pathTemplate: "$\"/v0/imports/{id}\"",
                                httpMethod: "PATCH",
                                baseUri: BaseUri,
                                request: __httpRequest!,
                                response: null,
                ...
                else
                {
                    await global::Exa.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            if (__effectiveReadResponseAsString)
                            {
                                ...
                                ProcessImportsUpdateResponseContent(
                                    httpClient: HttpClient,
                                    httpResponseMessage: __response,
                                    content: ref __content);
                                ...
                                try
                                {
                                    ...
                                    var __value = global::Exa.Import.FromJson(__content, JsonSerializerContext) ??
                                        throw new global::System.InvalidOperationException($"Response deserialization failed for \"{__content}\" ");
                                    return new global::Exa.AutoSDKHttpResponse<global::Exa.Import>(
                            ...
                            else
                            {
                                try
                                {
                                    ...
                                    var __value = await global::Exa.Import.FromJsonStreamAsync(__content, JsonSerializerContext).ConfigureAwait(false) ??
        ...
        public async global::System.Threading.Tasks.Task<global::Exa.Import> ImportsUpdateAsync(
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            var __request = new global::Exa.UpdateImport
            {
                Metadata = metadata,
                Title = title,
            };

            return await ImportsUpdateAsync(
                id: id,
                request: __request,
                requestOptions: requestOptions,
