...
{
    /// <inheritdoc />
    public sealed class GetContentsResponseStatuseStatusNullableJsonConverter : global::System.Text.Json.Serialization.JsonConverter<global::Exa.GetContentsResponseStatuseStatus?>
    {
        /// <inheritdoc />
            ...
            global::System.Text.Json.JsonSerializerOptions options)
        {
            ...
            {
                writer.WriteStringValue(global::Exa.GetContentsResponseStatuseStatusExtensions.ToValueString(value.Value));
            }
        }
    }
}
