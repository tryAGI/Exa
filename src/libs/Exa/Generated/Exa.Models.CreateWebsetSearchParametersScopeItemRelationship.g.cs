...
namespace Exa
{
    ...
    public sealed partial class CreateWebsetSearchParametersScopeItemRelationship
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="CreateWebsetSearchParametersScopeItemRelationship" /> class.
        /// </summary>
...
#endif
        public CreateWebsetSearchParametersScopeItemRelationship(
            string definition,
            double limit)
        {
