...
namespace Exa
{
    ...
    public sealed partial class ResearchDtoClassCompletedCitationProfileVariant2ContentVariant1FinancialsRevenueGrowth
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="ResearchDtoClassCompletedCitationProfileVariant2ContentVariant1FinancialsRevenueGrowth" /> class.
        /// </summary>
...
#endif
        public ResearchDtoClassCompletedCitationProfileVariant2ContentVariant1FinancialsRevenueGrowth(
            double current,
            double? monthly,
            double? monthlyPct,
            double? quarterly,
