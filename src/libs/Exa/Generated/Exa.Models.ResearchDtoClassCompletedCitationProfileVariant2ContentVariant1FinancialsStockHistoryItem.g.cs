...
namespace Exa
{
    ...
    public sealed partial class ResearchDtoClassCompletedCitationProfileVariant2ContentVariant1FinancialsStockHistoryItem
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="ResearchDtoClassCompletedCitationProfileVariant2ContentVariant1FinancialsStockHistoryItem" /> class.
        /// </summary>
...
#endif
        public ResearchDtoClassCompletedCitationProfileVariant2ContentVariant1FinancialsStockHistoryItem(
            double value,
            string dateFrom,
            string dateTo)
        {
