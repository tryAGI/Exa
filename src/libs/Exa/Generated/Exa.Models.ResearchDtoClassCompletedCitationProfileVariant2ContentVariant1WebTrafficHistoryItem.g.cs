...
namespace Exa
{
    ...
    public sealed partial class ResearchDtoClassCompletedCitationProfileVariant2ContentVariant1WebTrafficHistoryItem
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="ResearchDtoClassCompletedCitationProfileVariant2ContentVariant1WebTrafficHistoryItem" /> class.
        /// </summary>
...
#endif
        public ResearchDtoClassCompletedCitationProfileVariant2ContentVariant1WebTrafficHistoryItem(
            double value,
            string dateFrom,
            string dateTo)
        {
