...
namespace Exa
{
    ...
    public sealed partial class ResearchDtoClassCompletedCitationProfileVariant2ContentVariant2WorkforceGrowth
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="ResearchDtoClassCompletedCitationProfileVariant2ContentVariant2WorkforceGrowth" /> class.
        /// </summary>
...
#endif
        public ResearchDtoClassCompletedCitationProfileVariant2ContentVariant2WorkforceGrowth(
            double current,
            double? monthly,
            double? monthlyPct,
            double? quarterly,
