...
namespace Exa
{
    ...
    public sealed partial class SearchMonitorTrigger
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="SearchMonitorTrigger" /> class.
        /// </summary>
        /// <param name="period">
        /// A duration string specifying how often the monitor runs (e.g., "1h", "6h", "1d", "7d"). Single-unit only. Minimum interval is 1 hour. The schedule is anchored to the monitor's creation time (e.g., a daily monitor created at 2:30 PM runs daily around 2:30 PM).<br/>
        /// Example: 6h
        ...
        /// <summary>
        /// Creates a new <see cref="SearchMonitorTrigger"/> from its single non-const required field,
        /// hardcoding any const discriminator fields.
        /// </summary>
        public static SearchMonitorTrigger FromPeriod(string period)
        {
            return new SearchMonitorTrigger
            {
                Period = period,
            };
        }
