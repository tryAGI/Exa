...
namespace Exa
{
    public partial class MonitorsClient
    {
        ...
        private static readonly global::Exa.AutoSDKServer[] s_MonitorsListServers = new global::Exa.AutoSDKServer[]
        ...
        private static readonly global::Exa.EndPointSecurityRequirement s_MonitorsListSecurityRequirement0 =
        ...
        private static readonly global::Exa.EndPointSecurityRequirement[] s_MonitorsListSecurityRequirements =
            new global::Exa.EndPointSecurityRequirement[]
            {                s_MonitorsListSecurityRequirement0,
            };
        ...
        partial void ProcessMonitorsListResponseContent(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage,
            ref string content);
        ...
        {
            var __response = await MonitorsListAsResponseAsync(
                cursor: cursor,
                limit: limit,
                websetId: websetId,
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            PrepareArguments(
                client: HttpClient);
            PrepareMonitorsListArguments(
                httpClient: HttpClient,
                cursor: ref cursor,
                limit: ref limit,
                websetId: ref websetId);


            var __authorizations = global::Exa.EndPointSecurityResolver.ResolveAuthorizations(
                availableAuthorizations: Authorizations,
                securityRequirements: s_MonitorsListSecurityRequirements,
                operationName: "MonitorsListAsync");
            ...
            global::System.Net.Http.HttpRequestMessage __CreateHttpRequest()
            {
                            ...
                            var __pathBuilder = new global::Exa.PathBuilder(
                                ...
                                servers: s_MonitorsListServers,
                                defaultBaseUrl: "https://api.exa.ai/websets"));
                            __pathBuilder
                                .AddOptionalParameter("cursor", cursor)
                                .AddOptionalParameter("limit", limit?.ToString())
                                .AddOptionalParameter("websetId", websetId)
                                ;
                ...
                else
                {
                    await global::Exa.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            if (__effectiveReadResponseAsString)
                            {
                                ...
                                ProcessMonitorsListResponseContent(
                                    httpClient: HttpClient,
                                    httpResponseMessage: __response,
                                    content: ref __content);
                                ...
                                try
                                {
                                    ...
                                    var __value = global::Exa.ListMonitorsResponse.FromJson(__content, JsonSerializerContext) ??
                                        throw new global::System.InvalidOperationException($"Response deserialization failed for \"{__content}\" ");
                                    return new global::Exa.AutoSDKHttpResponse<global::Exa.ListMonitorsResponse>(
                            ...
                            else
                            {
                                try
                                {
                                    ...
                                    var __value = await global::Exa.ListMonitorsResponse.FromJsonStreamAsync(__content, JsonSerializerContext).ConfigureAwait(false) ??
