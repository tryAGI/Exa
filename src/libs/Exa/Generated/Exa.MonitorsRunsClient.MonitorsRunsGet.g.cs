...
namespace Exa
{
    public partial class MonitorsRunsClient
    {
        ...
        private static readonly global::Exa.AutoSDKServer[] s_MonitorsRunsGetServers = new global::Exa.AutoSDKServer[]
        ...
        private static readonly global::Exa.EndPointSecurityRequirement s_MonitorsRunsGetSecurityRequirement0 =
        ...
        private static readonly global::Exa.EndPointSecurityRequirement[] s_MonitorsRunsGetSecurityRequirements =
            new global::Exa.EndPointSecurityRequirement[]
            {                s_MonitorsRunsGetSecurityRequirement0,
            };
        partial void PrepareMonitorsRunsGetArguments(
            global::System.Net.Http.HttpClient httpClient,
            ref string monitor,
            ref string id);
        partial void PrepareMonitorsRunsGetRequest(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpRequestMessage httpRequestMessage,
            string monitor,
            string id);
        partial void ProcessMonitorsRunsGetResponse(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage);

        partial void ProcessMonitorsRunsGetResponseContent(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage,
            ref string content);
        ...
        /// </remarks>
        public async global::System.Threading.Tasks.Task<global::Exa.MonitorRun> MonitorsRunsGetAsync(
            string monitor,
            string id,
            global::Exa.AutoSDKRequestOptions? requestOptions = default,
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            var __response = await MonitorsRunsGetAsResponseAsync(
                monitor: monitor,
                id: id,
        ...
        /// console.log(`Monitor run: ${run.id} - ${run.status}`);
        /// </remarks>
        public async global::System.Threading.Tasks.Task<global::Exa.AutoSDKHttpResponse<global::Exa.MonitorRun>> MonitorsRunsGetAsResponseAsync(
            string monitor,
            string id,
            global::Exa.AutoSDKRequestOptions? requestOptions = default,
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            PrepareArguments(
                client: HttpClient);
            PrepareMonitorsRunsGetArguments(
            ...
            var __authorizations = global::Exa.EndPointSecurityResolver.ResolveAuthorizations(
                ...
                securityRequirements: s_MonitorsRunsGetSecurityRequirements,
                operationName: "MonitorsRunsGetAsync");
            ...
            global::System.Net.Http.HttpRequestMessage __CreateHttpRequest()
            {
                            ...
                            var __pathBuilder = new global::Exa.PathBuilder(
                                ...
                                servers: s_MonitorsRunsGetServers,
            ...
            try
            {
                for (var __attempt = 1; __attempt <= __maxAttempts; __attempt++)
                {
                    ...
                    await global::Exa.AutoSDKRequestOptionsSupport.OnBeforeRequestAsync(
                            ...
                            context: global::Exa.AutoSDKRequestOptionsSupport.CreateHookContext(
                                operationId: "MonitorsRunsGet",
                                methodName: "MonitorsRunsGetAsync",
                                pathTemplate: "$\"/v0/monitors/{monitor}/runs/{id}\"",
                                httpMethod: "GET",
                                baseUri: BaseUri,
                                request: __httpRequest!,
                                response: null,
                ...
                ProcessResponse(
                    client: HttpClient,
                    response: __response);
                ProcessMonitorsRunsGetResponse(
                    httpClient: HttpClient,
                ...
                else
                {
                    await global::Exa.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            if (__effectiveReadResponseAsString)
                            {
                                ...
                                ProcessMonitorsRunsGetResponseContent(
                                    httpClient: HttpClient,
                                    httpResponseMessage: __response,
                                    content: ref __content);
                                ...
                                try
                                {
                                    ...
                                    var __value = global::Exa.MonitorRun.FromJson(__content, JsonSerializerContext) ??
                                        throw new global::System.InvalidOperationException($"Response deserialization failed for \"{__content}\" ");
                                    return new global::Exa.AutoSDKHttpResponse<global::Exa.MonitorRun>(
                            ...
                            else
                            {
                                try
                                {
                                    ...
                                    var __value = await global::Exa.MonitorRun.FromJsonStreamAsync(__content, JsonSerializerContext).ConfigureAwait(false) ??
