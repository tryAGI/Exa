...
namespace Exa
{
    public partial class MonitorsRunsClient
    {

        private static readonly global::Exa.AutoSDKServer[] s_MonitorsRunsListServers = new global::Exa.AutoSDKServer[]
        ...
        private static readonly global::Exa.EndPointSecurityRequirement s_MonitorsRunsListSecurityRequirement0 =
        ...
        private static readonly global::Exa.EndPointSecurityRequirement[] s_MonitorsRunsListSecurityRequirements =
            new global::Exa.EndPointSecurityRequirement[]
            {                s_MonitorsRunsListSecurityRequirement0,
            };
        partial void PrepareMonitorsRunsListArguments(
            global::System.Net.Http.HttpClient httpClient,
            ref string monitor);
        partial void PrepareMonitorsRunsListRequest(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpRequestMessage httpRequestMessage,
            string monitor);
        partial void ProcessMonitorsRunsListResponse(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage);

        partial void ProcessMonitorsRunsListResponseContent(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage,
            ref string content);
        ...
        /// });
        /// </remarks>
        public async global::System.Threading.Tasks.Task<global::Exa.ListMonitorRunsResponse> MonitorsRunsListAsync(
            string monitor,
            global::Exa.AutoSDKRequestOptions? requestOptions = default,
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            var __response = await MonitorsRunsListAsResponseAsync(
                monitor: monitor,
        ...
        /// });
        /// </remarks>
        public async global::System.Threading.Tasks.Task<global::Exa.AutoSDKHttpResponse<global::Exa.ListMonitorRunsResponse>> MonitorsRunsListAsResponseAsync(
            string monitor,
            global::Exa.AutoSDKRequestOptions? requestOptions = default,
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            PrepareArguments(
                client: HttpClient);
            PrepareMonitorsRunsListArguments(
            ...
            var __authorizations = global::Exa.EndPointSecurityResolver.ResolveAuthorizations(
                ...
                securityRequirements: s_MonitorsRunsListSecurityRequirements,
                operationName: "MonitorsRunsListAsync");
            ...
            global::System.Net.Http.HttpRequestMessage __CreateHttpRequest()
            {
                            ...
                            var __pathBuilder = new global::Exa.PathBuilder(
                                ...
                                servers: s_MonitorsRunsListServers,
            ...
            foreach (var __authorization in __authorizations)
            {
                ...
                PrepareRequest(
                    client: HttpClient,
                    request: __httpRequest);
                PrepareMonitorsRunsListRequest(
                    httpClient: HttpClient,
            ...
            try
            {
                for (var __attempt = 1; __attempt <= __maxAttempts; __attempt++)
                {
                    ...
                    await global::Exa.AutoSDKRequestOptionsSupport.OnBeforeRequestAsync(
                            ...
                            context: global::Exa.AutoSDKRequestOptionsSupport.CreateHookContext(
                                operationId: "MonitorsRunsList",
                                methodName: "MonitorsRunsListAsync",
                                pathTemplate: "$\"/v0/monitors/{monitor}/runs\"",
                                httpMethod: "GET",
                                baseUri: BaseUri,
                                request: __httpRequest!,
                                response: null,
                ...
                ProcessResponse(
                    client: HttpClient,
                    response: __response);
                ProcessMonitorsRunsListResponse(
                    httpClient: HttpClient,
                ...
                else
                {
                    await global::Exa.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            if (__effectiveReadResponseAsString)
                            {
                                ...
                                ProcessMonitorsRunsListResponseContent(
                                    httpClient: HttpClient,
                                    httpResponseMessage: __response,
                                    content: ref __content);
                                ...
                                try
                                {
                                    ...
                                    var __value = global::Exa.ListMonitorRunsResponse.FromJson(__content, JsonSerializerContext) ??
                                        throw new global::System.InvalidOperationException($"Response deserialization failed for \"{__content}\" ");
                                    return new global::Exa.AutoSDKHttpResponse<global::Exa.ListMonitorRunsResponse>(
                            ...
                            else
                            {
                                try
                                {
                                    ...
                                    var __value = await global::Exa.ListMonitorRunsResponse.FromJsonStreamAsync(__content, JsonSerializerContext).ConfigureAwait(false) ??
