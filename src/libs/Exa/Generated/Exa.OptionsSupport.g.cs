...
namespace Exa
{
    ...
    public sealed class AutoSDKClientOptions
    {
        ...
        /// </summary>
        public global::Exa.AutoSDKRetryOptions Retry { get; set; } = new global::Exa.AutoSDKRetryOptions();
        ...
        /// </summary>
        public global::System.Collections.Generic.List<global::Exa.IAutoSDKHook> Hooks { get; } =
            new global::System.Collections.Generic.List<global::Exa.IAutoSDKHook>();
        ...
        public global::Exa.AutoSDKClientOptions AddHook(
            global::Exa.IAutoSDKHook hook)
        {
        ...
        /// </summary>
        public global::Exa.IAutoSDKAuthorizationProvider? AuthorizationProvider { get; set; }
        ...
        public global::Exa.AutoSDKClientOptions UseAuthorizationProvider(
            global::Exa.IAutoSDKAuthorizationProvider provider)
        {
            AuthorizationProvider = provider ?? throw new global::System.ArgumentNullException(nameof(provider));
            if (Hooks.Find(static x => x is global::Exa.AutoSDKAuthorizationProviderHook) == null)
            {
                Hooks.Add(new global::Exa.AutoSDKAuthorizationProviderHook());
            }
    ...
    public readonly struct AutoSDKAuthorizationValue
    {
        ...
        public static global::Exa.AutoSDKAuthorizationValue Bearer(string token) => new(value: token, scheme: "Bearer");

        /// <summary>Convenience factory for an API-key header.</summary>
        public static global::Exa.AutoSDKAuthorizationValue ApiKeyHeader(string name, string value) =>
    ...
    public interface IAutoSDKAuthorizationProvider
    {
        ...
        global::System.Threading.Tasks.Task<global::System.Collections.Generic.IReadOnlyList<global::Exa.AutoSDKAuthorizationValue>?> ResolveAsync(
            global::Exa.AutoSDKHookContext context);
    }
...
#pragma warning restore CS0618
    ...
    /// </summary>
    public sealed class AutoSDKAuthorizationProviderHook : global::Exa.AutoSDKHook
    {
        /// <inheritdoc />
            ...
            global::Exa.AutoSDKHookContext context)
        {
            ...
            if (perRequest != null && perRequest.Count > 0)
            {
                ...
                global::Exa.AutoSDKHttpRequestOptions.StampAuthorizationOverride(context.Request);
                return;
            }
        ...
        private static void ApplyAuthorization(
            global::System.Net.Http.HttpRequestMessage request,
            global::Exa.AutoSDKAuthorizationValue authorization)
        {
    ...
    public sealed class AutoSDKRequestOptions
    {
        ...
        /// </summary>
        public global::Exa.AutoSDKRetryOptions? Retry { get; set; }
        ...
        /// </summary>
        public global::System.Collections.Generic.IReadOnlyList<global::Exa.AutoSDKAuthorizationValue>? Authorizations { get; set; }
    }
    ...
    /// </summary>
    public abstract class AutoSDKHook : global::Exa.IAutoSDKHook
    {
        /// <inheritdoc />
    ...
    public sealed class AutoSDKHookContext
    {
        ...
        /// </summary>
        public global::Exa.AutoSDKClientOptions ClientOptions { get; set; } = null!;

        /// <summary>
        /// The per-request runtime options.
        /// </summary>
        public global::Exa.AutoSDKRequestOptions? RequestOptions { get; set; }
    ...
    {
        internal static global::Exa.AutoSDKHookContext CreateHookContext(
            string operationId,
            string methodName,
            string pathTemplate,
            string httpMethod,
            ...
            global::Exa.AutoSDKClientOptions clientOptions,
            global::Exa.AutoSDKRequestOptions? requestOptions,
            int attempt,
            int maxAttempts,
            bool willRetry,
        ...
        {
            return new global::Exa.AutoSDKHookContext
            {
        ...
        internal static global::System.TimeSpan GetRetryDelay(
            ...
            int attempt)
        {
            var retryOptions = requestOptions?.Retry ?? clientOptions.Retry ?? new global::Exa.AutoSDKRetryOptions();
        ...
        private static global::System.TimeSpan ClampRetryDelay(
            global::System.TimeSpan delay,
            global::Exa.AutoSDKRetryOptions retryOptions)
        {
        ...
        private static async global::System.Threading.Tasks.Task InvokeHooksAsync(
            global::Exa.AutoSDKClientOptions clientOptions,
            global::System.Func<global::Exa.IAutoSDKHook, global::Exa.AutoSDKHookContext, global::System.Threading.Tasks.Task> callback,
            global::Exa.AutoSDKHookContext context)
        {
