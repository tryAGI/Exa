...
namespace Exa
{
    public partial class RunsClient
    {
        ...
        private static readonly global::Exa.EndPointSecurityRequirement s_GetRunSecurityRequirement0 =
        ...
        private static readonly global::Exa.EndPointSecurityRequirement[] s_GetRunSecurityRequirements =
            new global::Exa.EndPointSecurityRequirement[]
        ...
        public async global::System.Threading.Tasks.Task<global::Exa.SearchMonitorRun> GetRunAsync(
            string id,
            string runId,
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::Exa.ApiException"></exception>
        public async global::System.Threading.Tasks.Task<global::Exa.AutoSDKHttpResponse<global::Exa.SearchMonitorRun>> GetRunAsResponseAsync(
            string id,
            string runId,
            global::Exa.AutoSDKRequestOptions? requestOptions = default,
            global::System.Threading.CancellationToken cancellationToken = default)
                ...
                for (var __attempt = 1; __attempt <= __maxAttempts; __attempt++)
                {
                    ...
                    await global::Exa.AutoSDKRequestOptionsSupport.OnBeforeRequestAsync(
                            ...
                            context: global::Exa.AutoSDKRequestOptionsSupport.CreateHookContext(
                                ...
                                pathTemplate: "$\"/monitors/{id}/runs/{runId}\"",
                                httpMethod: "GET",
                                baseUri: BaseUri,
                                request: __httpRequest!,
                                response: null,
                    ...
                    await global::Exa.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            if (__effectiveReadResponseAsString)
                            {
                                ...
                                try
                                {
                                    ...
                                    var __value = global::Exa.SearchMonitorRun.FromJson(__content, JsonSerializerContext) ??
                                        throw new global::System.InvalidOperationException($"Response deserialization failed for \"{__content}\" ");
                                    return new global::Exa.AutoSDKHttpResponse<global::Exa.SearchMonitorRun>(
                            ...
                            else
                            {
                                try
                                {
                                    ...
                                    var __value = await global::Exa.SearchMonitorRun.FromJsonStreamAsync(__content, JsonSerializerContext).ConfigureAwait(false) ??
