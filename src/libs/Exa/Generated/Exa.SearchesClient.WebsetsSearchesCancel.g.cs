...
namespace Exa
{
    public partial class SearchesClient
    {
        ...
        private static readonly global::Exa.AutoSDKServer[] s_WebsetsSearchesCancelServers = new global::Exa.AutoSDKServer[]
        ...
        private static readonly global::Exa.EndPointSecurityRequirement s_WebsetsSearchesCancelSecurityRequirement0 =
        ...
        private static readonly global::Exa.EndPointSecurityRequirement[] s_WebsetsSearchesCancelSecurityRequirements =
            new global::Exa.EndPointSecurityRequirement[]
            {                s_WebsetsSearchesCancelSecurityRequirement0,
            };
        partial void PrepareWebsetsSearchesCancelArguments(
            global::System.Net.Http.HttpClient httpClient,
            ref string webset,
            ref string id);
        partial void PrepareWebsetsSearchesCancelRequest(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpRequestMessage httpRequestMessage,
            string webset,
            string id);
        partial void ProcessWebsetsSearchesCancelResponse(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage);

        partial void ProcessWebsetsSearchesCancelResponseContent(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage,
            ref string content);
        ...
        /// </remarks>
        public async global::System.Threading.Tasks.Task<global::Exa.WebsetSearch> WebsetsSearchesCancelAsync(
            string webset,
            string id,
            global::Exa.AutoSDKRequestOptions? requestOptions = default,
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            var __response = await WebsetsSearchesCancelAsResponseAsync(
                webset: webset,
                id: id,
        ...
        /// console.log(`Cancelled search: ${search.id}`);
        /// </remarks>
        public async global::System.Threading.Tasks.Task<global::Exa.AutoSDKHttpResponse<global::Exa.WebsetSearch>> WebsetsSearchesCancelAsResponseAsync(
            string webset,
            string id,
            global::Exa.AutoSDKRequestOptions? requestOptions = default,
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            PrepareArguments(
                client: HttpClient);
            PrepareWebsetsSearchesCancelArguments(
            ...
            var __authorizations = global::Exa.EndPointSecurityResolver.ResolveAuthorizations(
                ...
                securityRequirements: s_WebsetsSearchesCancelSecurityRequirements,
                operationName: "WebsetsSearchesCancelAsync");
            ...
            global::System.Net.Http.HttpRequestMessage __CreateHttpRequest()
            {
                            ...
                            var __pathBuilder = new global::Exa.PathBuilder(
                                ...
                                servers: s_WebsetsSearchesCancelServers,
            ...
            foreach (var __authorization in __authorizations)
            {
                ...
                PrepareRequest(
                    client: HttpClient,
                    request: __httpRequest);
                PrepareWebsetsSearchesCancelRequest(
                    httpClient: HttpClient,
            ...
            try
            {
                for (var __attempt = 1; __attempt <= __maxAttempts; __attempt++)
                {
                    ...
                    await global::Exa.AutoSDKRequestOptionsSupport.OnBeforeRequestAsync(
                            ...
                            context: global::Exa.AutoSDKRequestOptionsSupport.CreateHookContext(
                                operationId: "WebsetsSearchesCancel",
                                methodName: "WebsetsSearchesCancelAsync",
                                pathTemplate: "$\"/v0/websets/{webset}/searches/{id}/cancel\"",
                                httpMethod: "POST",
                                baseUri: BaseUri,
                                request: __httpRequest!,
                                response: null,
                ...
                ProcessResponse(
                    client: HttpClient,
                    response: __response);
                ProcessWebsetsSearchesCancelResponse(
                    httpClient: HttpClient,
                ...
                else
                {
                    await global::Exa.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            if (__effectiveReadResponseAsString)
                            {
                                ...
                                ProcessWebsetsSearchesCancelResponseContent(
                                    httpClient: HttpClient,
                                    httpResponseMessage: __response,
                                    content: ref __content);
