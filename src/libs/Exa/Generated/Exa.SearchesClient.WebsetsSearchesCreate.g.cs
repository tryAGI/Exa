...
namespace Exa
{
    public partial class SearchesClient
    {

        private static readonly global::Exa.AutoSDKServer[] s_WebsetsSearchesCreateServers = new global::Exa.AutoSDKServer[]
        ...
        private static readonly global::Exa.EndPointSecurityRequirement s_WebsetsSearchesCreateSecurityRequirement0 =
        ...
        private static readonly global::Exa.EndPointSecurityRequirement[] s_WebsetsSearchesCreateSecurityRequirements =
            new global::Exa.EndPointSecurityRequirement[]
            {                s_WebsetsSearchesCreateSecurityRequirement0,
            };
        partial void PrepareWebsetsSearchesCreateArguments(
            global::System.Net.Http.HttpClient httpClient,
            ref string webset,
            global::Exa.CreateWebsetSearchParameters request);
        partial void PrepareWebsetsSearchesCreateRequest(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpRequestMessage httpRequestMessage,
            string webset,
            global::Exa.CreateWebsetSearchParameters request);
        partial void ProcessWebsetsSearchesCreateResponse(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage);

        partial void ProcessWebsetsSearchesCreateResponseContent(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage,
            ref string content);
        ...
        /// </remarks>
        public async global::System.Threading.Tasks.Task<global::Exa.WebsetSearch> WebsetsSearchesCreateAsync(
            string webset,
        ...
        {
            var __response = await WebsetsSearchesCreateAsResponseAsync(
                webset: webset,
        ...
        /// console.log(`Created search: ${search.id}`);
        /// </remarks>
        public async global::System.Threading.Tasks.Task<global::Exa.AutoSDKHttpResponse<global::Exa.WebsetSearch>> WebsetsSearchesCreateAsResponseAsync(
            string webset,
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            ...
            PrepareArguments(
                client: HttpClient);
            PrepareWebsetsSearchesCreateArguments(
            ...
            var __authorizations = global::Exa.EndPointSecurityResolver.ResolveAuthorizations(
                ...
                securityRequirements: s_WebsetsSearchesCreateSecurityRequirements,
                operationName: "WebsetsSearchesCreateAsync");
            ...
            global::System.Net.Http.HttpRequestMessage __CreateHttpRequest()
            {
                            ...
                            var __pathBuilder = new global::Exa.PathBuilder(
                                ...
                                servers: s_WebsetsSearchesCreateServers,
            ...
            foreach (var __authorization in __authorizations)
            {
                ...
                PrepareRequest(
                    client: HttpClient,
                    request: __httpRequest);
                PrepareWebsetsSearchesCreateRequest(
                    httpClient: HttpClient,
            ...
            try
            {
                for (var __attempt = 1; __attempt <= __maxAttempts; __attempt++)
                {
                    ...
                    await global::Exa.AutoSDKRequestOptionsSupport.OnBeforeRequestAsync(
                            ...
                            context: global::Exa.AutoSDKRequestOptionsSupport.CreateHookContext(
                                operationId: "WebsetsSearchesCreate",
                                methodName: "WebsetsSearchesCreateAsync",
                                pathTemplate: "$\"/v0/websets/{webset}/searches\"",
                                httpMethod: "POST",
                                baseUri: BaseUri,
                                request: __httpRequest!,
                                response: null,
                ...
                ProcessResponse(
                    client: HttpClient,
                    response: __response);
                ProcessWebsetsSearchesCreateResponse(
                    httpClient: HttpClient,
                ...
                else
                {
                    await global::Exa.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            if (__effectiveReadResponseAsString)
                            {
                                ...
                                ProcessWebsetsSearchesCreateResponseContent(
                                    httpClient: HttpClient,
                                    httpResponseMessage: __response,
                                    content: ref __content);
                                ...
                                try
                                {
                                    ...
                                    var __value = global::Exa.WebsetSearch.FromJson(__content, JsonSerializerContext) ??
                                        throw new global::System.InvalidOperationException($"Response deserialization failed for \"{__content}\" ");
                                    return new global::Exa.AutoSDKHttpResponse<global::Exa.WebsetSearch>(
                            ...
                            else
                            {
                                try
                                {
                                    ...
                                    var __value = await global::Exa.WebsetSearch.FromJsonStreamAsync(__content, JsonSerializerContext).ConfigureAwait(false) ??
        ...
        public async global::System.Threading.Tasks.Task<global::Exa.WebsetSearch> WebsetsSearchesCreateAsync(
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            var __request = new global::Exa.CreateWebsetSearchParameters
            {
                Count = count,
                Query = query,
                Entity = entity,
            ...
            return await WebsetsSearchesCreateAsync(
                webset: webset,
                request: __request,
                requestOptions: requestOptions,
