...
namespace Exa
{
    public partial class SearchesClient
    {
        ...
        private static readonly global::Exa.AutoSDKServer[] s_WebsetsSearchesGetServers = new global::Exa.AutoSDKServer[]
        ...
        private static readonly global::Exa.EndPointSecurityRequirement s_WebsetsSearchesGetSecurityRequirement0 =
        ...
        private static readonly global::Exa.EndPointSecurityRequirement[] s_WebsetsSearchesGetSecurityRequirements =
            new global::Exa.EndPointSecurityRequirement[]
            {                s_WebsetsSearchesGetSecurityRequirement0,
            };
        partial void PrepareWebsetsSearchesGetArguments(
            global::System.Net.Http.HttpClient httpClient,
            ref string webset,
            ref string id);
        partial void PrepareWebsetsSearchesGetRequest(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpRequestMessage httpRequestMessage,
            string webset,
            string id);
        partial void ProcessWebsetsSearchesGetResponse(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage);

        partial void ProcessWebsetsSearchesGetResponseContent(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage,
            ref string content);
        ...
        /// </remarks>
        public async global::System.Threading.Tasks.Task<global::Exa.WebsetSearch> WebsetsSearchesGetAsync(
            string webset,
            string id,
            global::Exa.AutoSDKRequestOptions? requestOptions = default,
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            var __response = await WebsetsSearchesGetAsResponseAsync(
                webset: webset,
                id: id,
        ...
        /// console.log(`Search: ${search.id} - ${search.status}`);
        /// </remarks>
        public async global::System.Threading.Tasks.Task<global::Exa.AutoSDKHttpResponse<global::Exa.WebsetSearch>> WebsetsSearchesGetAsResponseAsync(
            string webset,
            string id,
            global::Exa.AutoSDKRequestOptions? requestOptions = default,
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            PrepareArguments(
                client: HttpClient);
            PrepareWebsetsSearchesGetArguments(
            ...
            var __authorizations = global::Exa.EndPointSecurityResolver.ResolveAuthorizations(
                ...
                securityRequirements: s_WebsetsSearchesGetSecurityRequirements,
                operationName: "WebsetsSearchesGetAsync");
            ...
            global::System.Net.Http.HttpRequestMessage __CreateHttpRequest()
            {
                            ...
                            var __pathBuilder = new global::Exa.PathBuilder(
                                ...
                                servers: s_WebsetsSearchesGetServers,
            ...
            foreach (var __authorization in __authorizations)
            {
                ...
                PrepareRequest(
                    client: HttpClient,
                    request: __httpRequest);
                PrepareWebsetsSearchesGetRequest(
                    httpClient: HttpClient,
            ...
            try
            {
                for (var __attempt = 1; __attempt <= __maxAttempts; __attempt++)
                {
                    ...
                    await global::Exa.AutoSDKRequestOptionsSupport.OnBeforeRequestAsync(
                            ...
                            context: global::Exa.AutoSDKRequestOptionsSupport.CreateHookContext(
                                operationId: "WebsetsSearchesGet",
                                methodName: "WebsetsSearchesGetAsync",
                                pathTemplate: "$\"/v0/websets/{webset}/searches/{id}\"",
                                httpMethod: "GET",
                                baseUri: BaseUri,
                                request: __httpRequest!,
                                response: null,
                ...
                ProcessResponse(
                    client: HttpClient,
                    response: __response);
                ProcessWebsetsSearchesGetResponse(
                    httpClient: HttpClient,
                ...
                else
                {
                    await global::Exa.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            if (__effectiveReadResponseAsString)
                            {
                                ...
                                ProcessWebsetsSearchesGetResponseContent(
                                    httpClient: HttpClient,
                                    httpResponseMessage: __response,
                                    content: ref __content);
