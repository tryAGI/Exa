...
namespace Exa
{
    public partial class WebhooksAttemptsClient
    {
        ...
        private static readonly global::Exa.EndPointSecurityRequirement[] s_WebhooksAttemptsListSecurityRequirements =
            new global::Exa.EndPointSecurityRequirement[]
            {                s_WebhooksAttemptsListSecurityRequirement0,
            };
        partial void PrepareWebhooksAttemptsListArguments(
        ...
        partial void ProcessWebhooksAttemptsListResponseContent(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage,
            ref string content);
        ...
        {
            var __response = await WebhooksAttemptsListAsResponseAsync(
                id: id,
                cursor: cursor,
                limit: limit,
                eventType: eventType,
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            PrepareArguments(
                client: HttpClient);
            PrepareWebhooksAttemptsListArguments(
            ...
            var __authorizations = global::Exa.EndPointSecurityResolver.ResolveAuthorizations(
                ...
                securityRequirements: s_WebhooksAttemptsListSecurityRequirements,
                operationName: "WebhooksAttemptsListAsync");
            ...
            global::System.Net.Http.HttpRequestMessage __CreateHttpRequest()
            {
                            ...
                            __pathBuilder
                                ...
                                .AddOptionalParameter("eventType", eventType?.ToValueString())
                                .AddOptionalParameter("successful", successful?.ToString().ToLowerInvariant())
                                ;
            ...
            foreach (var __authorization in __authorizations)
            {
                ...
                PrepareRequest(
                    client: HttpClient,
                    request: __httpRequest);
                PrepareWebhooksAttemptsListRequest(
                    httpClient: HttpClient,
            ...
            try
            {
                for (var __attempt = 1; __attempt <= __maxAttempts; __attempt++)
                {
                    ...
                    await global::Exa.AutoSDKRequestOptionsSupport.OnBeforeRequestAsync(
                            ...
                            context: global::Exa.AutoSDKRequestOptionsSupport.CreateHookContext(
                                operationId: "WebhooksAttemptsList",
                                methodName: "WebhooksAttemptsListAsync",
                                pathTemplate: "$\"/v0/webhooks/{id}/attempts\"",
                                httpMethod: "GET",
                                baseUri: BaseUri,
                                request: __httpRequest!,
                                response: null,
                ...
                ProcessResponse(
                    client: HttpClient,
                    response: __response);
                ProcessWebhooksAttemptsListResponse(
                    httpClient: HttpClient,
                ...
                else
                {
                    await global::Exa.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            if (__effectiveReadResponseAsString)
                            {
                                ...
                                ProcessWebhooksAttemptsListResponseContent(
                                    httpClient: HttpClient,
                                    httpResponseMessage: __response,
                                    content: ref __content);
                                ...
                                try
                                {
                                    ...
                                    var __value = global::Exa.ListWebhookAttemptsResponse.FromJson(__content, JsonSerializerContext) ??
                                        throw new global::System.InvalidOperationException($"Response deserialization failed for \"{__content}\" ");
                                    return new global::Exa.AutoSDKHttpResponse<global::Exa.ListWebhookAttemptsResponse>(
                            ...
                            else
                            {
                                try
                                {
                                    ...
                                    var __value = await global::Exa.ListWebhookAttemptsResponse.FromJsonStreamAsync(__content, JsonSerializerContext).ConfigureAwait(false) ??
